...
p4 + theme_pubr(base_size = 18, base_family = "serif",
                legend = "right")
...
radarplotting_overlap(Radar_RSN_community, 80, 0, 1, 1,
                      alpha = .8, label_size = 1.35,
                      title = NULL,
                      palette = c("#D7301F", "#FC8D59", "#08519C", "#FDCC8A")
) + 
  text(x = -0.4, y = 0.7, "RS Net1", cex = 1.75, col = "#D7301F", font = 2, family = "serif") + 
  text(x = 0.6, y = -0.125, "RS Net2", cex = 1.75, col = "#FC8D59", font = 2, family = "serif") + 
  text(x = -0.65, y = 0.3, "RS Net3", cex = 1.75, col = "#FDCC8A", font = 2, family = "serif") + 
  text(x = -0.45, y = -0.5, "RS Net4", cex = 1.75, col = "#08519C", font = 2, family = "serif") 
