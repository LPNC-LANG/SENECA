...
synergistic_integration_YM <- ggplot() + geom_brain(
  atlas       = atlas_plot %>% 
...
###############
deactivation_YM <- ggplot() + geom_brain(
  atlas       = atlas_plot %>% 
...
provincial_peripheral <- ggplot() + geom_brain(
  atlas       = atlas_plot %>% 
    mutate(ACTIVATION = 
...
redundant_integration_MO <- ggplot() + geom_brain(
  atlas       = atlas_plot %>% 
...
subcortical_MO <- ggplot() + geom_brain(
