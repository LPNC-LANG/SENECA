vis.gam.1<-function (x, view = NULL, cond = list(), n.grid = 30, too.far = 0, 
                     col = NA, color = "heat", contour.col = NULL, se = -1, type = "link", 
                     plot.type = "persp", zlim = NULL, nCol = 50, zlab.1='RESPONSE',...) 
{
  ...
  if (se <= 0) {
    ...
    if (color == "heat") {
      ...
      pal <- grDevices::colorRampPalette(c("#4BACC6", "#E97373"), bias = 10)(nCol)
      con.col <- 1
    }
